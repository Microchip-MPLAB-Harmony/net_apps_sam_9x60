...
# Harmony 3 TCP/IP Application for SAM 9X60 Family
...
| Folder     | Description                              |
| ---        | ---                                      |
| apps       | Demonstration of TCP/IP SAM 9X60 Applications     |
| docs       | Documents TCP/IP Application in html format for offline viewing. Use [github pages](https://microchip-mplab-harmony.github.io/net_apps_sam_9x60/) of this repository for viewing it online. |
